          ...
          <div className="grid md:grid-cols-3 gap-12">
            ...
            <div className="bg-muted/30 border border-border rounded-lg p-8 h-fit">
              ...
              <div className="space-y-3">
                <button className="w-full px-6 py-3 bg-accent text-black font-bold rounded-lg hover:shadow-[0_0_30px_rgba(0,212,255,0.6)] transition-all flex items-center justify-center gap-2">
                  <Download size={18} />
                  Download Invoice
                </button>
                ...
                <Link
                  href="/merch"
                  className="block text-center px-6 py-3 bg-accent text-black font-bold rounded-lg hover:shadow-[0_0_20px_rgba(0,212,255,0.6)] transition-all"
                >
                  Continue Shopping
                </Link>
              </div>
