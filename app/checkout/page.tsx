          ...
          <div className="md:col-span-2">
            <form onSubmit={handleCheckout} className="space-y-8">
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full px-8 py-4 bg-accent text-primary font-bold rounded-lg hover:shadow-[0_0_30px_rgba(0,212,255,0.6)] transition-all disabled:opacity-50 flex items-center justify-center gap-2"
              >
                {loading ? (
                  <>
