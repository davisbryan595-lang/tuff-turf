  ...
  return (
    <div className="group rounded-lg overflow-hidden border border-border hover:border-accent transition-all duration-300 hover:shadow-[0_0_30px_rgba(0,212,255,0.3)] animate-float-in flex flex-col h-full">
      ...
      <div className="relative h-80 overflow-hidden bg-muted">
        ...
        />
        <div className="absolute top-4 right-4 bg-accent text-accent-foreground px-4 py-2 rounded-full font-bold text-xs">
          {product.badge}
        </div>
      </div>
      ...
      <div className="p-6 flex flex-col flex-1">
        ...
        <button
          ...
          className="w-full px-6 py-3 bg-accent text-accent-foreground font-bold rounded-lg hover:shadow-[0_0_30px_rgba(0,212,255,0.6)] transition-all hover:scale-105 disabled:opacity-50 flex items-center justify-center gap-2 mb-2"
        >
        ...
        <button
          ...
          disabled={product.category === "service" && !canAddToCart}
          className="w-full px-6 py-2 bg-accent text-accent-foreground font-bold rounded-lg hover:shadow-[0_0_20px_rgba(0,212,255,0.6)] transition-all disabled:opacity-50"
        >
          BUY NOW
        </button>
      </div>
