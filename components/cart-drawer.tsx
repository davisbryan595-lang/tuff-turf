          ...
          {items.length === 0 ? (
            <div className="flex flex-col items-center justify-center h-full text-center">
              ...
              <Link
                href="/merch"
                onClick={onClose}
                className="mt-4 px-6 py-2 bg-accent text-black font-bold rounded-lg hover:shadow-[0_0_20px_rgba(0,212,255,0.6)] transition-all"
              >
                Continue Shopping
              </Link>
            </div>
          ...
          <>
            ...
            <div className="border-t border-border p-6">
              <div className="mb-4">
                ...
                <div className="flex gap-2">
                  ...
                  <button
                    ...
                    disabled={!!activePromoCode}
                    className="px-4 py-2 bg-accent text-black font-bold text-sm rounded hover:shadow-[0_0_15px_rgba(0,212,255,0.6)] transition-all disabled:opacity-50"
                  >
                    Apply
                  </button>
                </div>
              ...
              <Link
                href="/checkout"
                onClick={onClose}
                className="block w-full text-center px-6 py-3 bg-accent text-black font-bold rounded-lg hover:shadow-[0_0_30px_rgba(0,212,255,0.6)] transition-all"
              >
                Proceed to Checkout
              </Link>
            </div>
